...
public class SelectFileByBrowserActivity extends AppCompatActivity
    ...
    private void initUi() {
        ...
        mToolBar.setNavigationIcon(R.drawable.ic_nav_back_white);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (i == R.id.browser_select_count) {
            ...
            new AlertDialog
                    ...
                    .setNegativeButton(getString(R.string.descending), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                    ...
                    .setPositiveButton(getString(R.string.ascending), new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            switch (mSelectSortTypeIndex) {
                                case 0:
                    ...
                    .setTitle(getString(R.string.please_choose_file))
                    .show();
